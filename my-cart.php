...
<?php
 ...
 <?php
	...
	?>
				...
				<tr>
					<td class="romove-item"><input type="checkbox" name="remove_code[]" value="<?php ?>" /></td>
					<td class="cart-image">
					//Display painting image						
						<img src="admin/paintingImages/<?php   ?>" alt="" width="114" height="146">						
					</td>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Grand Total<span class="inner-left-md"><?php echo "$"  ?>.00</span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
