...
<h3>Paintings Portal</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> This is an online painting store</p>
...
<div class="contact-timing">
	<div class="module-heading">
		<h4 class="module-title"> Art Gallery Opening Time</h4>
	</div><!-- /.module-heading -->
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(613) 0000000<br>(613) 00000000</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">info@algonquincollege.com</a></span>
                </div>
            </li>
